...
const loginUser=asyncHandler(async(req,res)=>{
   ...
   .json(
    new ApiSuccess(
        ...
        {
            user:loggedInUser,accessToken,refreshToken // save user in its cookie
...
const refreshAccessToken=asyncHandler(async(req,res)=>
    {
       const incomingRefreshToken= req.cookies.refreshToken || req.body.refreshToken
        ...
        try{
                    const decodedToken=verifyJWT.verify(incomingRefreshToken,process.env.
...
const changeCurrentPassword=asyncHandler(async(req,res)=>{
  ...
  .status(200)
  .json(
    new ApiRespose(200,{}, "Password changed successfully"       
  ))
})
...
const getCurrentUser=asyncHandler(async(req,res)=>{
    ...
    .status(200)
    .json(
        new ApiRespose(200,req.user,"Current user fetched successfully")
    )
})
